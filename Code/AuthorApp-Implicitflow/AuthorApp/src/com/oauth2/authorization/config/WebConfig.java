 ...
 */
@Configuration
@ComponentScan(basePackages = { "com.oauth2.authorization" })
@EnableWebMvc
public class WebConfig extends WebMvcConfigurerAdapter {
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		//it works only when using AbstractAnnotationConfigDispatcherServletInitializer 
		//it won't work if  implements WebApplicationInitializer
