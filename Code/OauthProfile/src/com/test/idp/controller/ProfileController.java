...
import com.test.idp.exception.UserException;
import com.test.idp.service.APIService;
...
public class ProfileController extends BaseController {
	...
	public void idpSelection(HttpServletRequest request, Model model, HttpServletResponse response)
		...
		String samlRedirectURL = (String) request.getAttribute(SAMLDiscovery.RETURN_URL);
